...
const Footer = () => {
  return (
    <footer className='w-full text-lg text-gray-200'>
        <Layout className=' xx:py-3 flex xx:flex-col sm:flex-row items-center  justify-between'>
            ...
            <nav className='flex items-center justify-center flex-wrap xx:py-2 xx:mr-2'>
                ...
                <motion.a href='https://linkedin.com/in/uche-chukwu-248bb8280' target={'_blank'} className='w-8 ml-3'
                    whileHover={{ y: -4 }}
                    whileTap={{ scale: 0.9 }}>
                    <LinkedInIcon />
                </motion.a>
