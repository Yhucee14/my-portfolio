                ...
                <Layout className='pt-5'>
                    ...
                    <div >
                        ...
                        {FeaturedProjects.map((pro) => (
                            <article key={pro} className=' border border-solid p-5 border-black shadow-2xl rounded-3xl  w-full flex items-center justify-between  '>
                    ...
                    <div className='grid grid-cols-2 gap-8'>
                        ...
                        {OtherProjects.map((pro) => (
                            <article key={pro} className=' border border-solid border-black shadow-2xl p-2 rounded-3xl w-full flex flex-col  justify-between  '>
