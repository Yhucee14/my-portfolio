...
import me from "../pages/profile/me.jpeg";
    ...
    <>
      ...
      <main className="flex w-full flex-col text-gray-300 items-center justify-center">
        <Layout className="pt-8">
          <AnimatedText
            text="Writing Lines That Transform Lives."
            className="xx:text-3xl sm:text-4xl mb-8"
          />
          ...
          <div className="grid w-full md:grid-cols-9 xx:grid-cols-3 gap-10">
            <div className="col-span-3 relative rounded-2xl border-2 border-solid border-gray-300 bg-green p-2 px-2">
              ...
              <Image
                src={me}
                alt="img"
                className="w-full h-full  xx:w-full rounded-2xl"
              />
            </div>
            ...
            <div className="col-span-3 flex flex-col items-start justify-center">
              ...
              <p className="my-2 font-medium">
                ...
                things look pretty, it is about solving problems and creating
                intuitive, enjoyable experiences for users.
              </p>
              <p className="font-medium">
                I always bring my commitment to excellence and user-centered
                thinking to every project I work on and i look forward to the
