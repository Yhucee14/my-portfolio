        ...
        <Layout className="border-b-2 border-b-gray-200">
          <div className="flex xx:flex-col sm:flex-col md:flex-row items-center justify-between w-full">
            <div className="  md:w-[1/2]  p-2">
              <div className="xx:w-full rounded-full border-2 border-solid border-gray-200">
                <Image
                  src={pro}
                  alt="img"
            ...
            <div className="w-[1/2]">
              <div className=" xx:w-full md:px-14 py-3 flex flex-col self-center">
                <AnimatedText
                  text="Hello, I am Uche."
                  className="sm:!text-4xl xx:text-3xl !text-left"
                />
                <p className="my-4 text-base font-medium">
                  As a Front-End Web developer, I am dedicated to turning ideas
                  into innovative web applications. Explore my latest projects
                  showcasing my abilities in web development.
                </p>
                ...
                border-2 border-solid border-gray-400 hover:border-blue-500"
                  ...
                  <Link
                    href="mailto:uchechukwu7814@gmail.com"
                    target={"_blank"}
